...
### Menu Location
Press:<br># Catalog ([2nd] + 2 on 92/+/v200) to access the catalog menu<br># F to scroll to the F section<br># Use arrows to navigate to Func<br>Or type Func using the keyboard
# Func ... EndFunc Block
