...
> **Note:** Downloading programs is only necessary if you are looking for programs to use on your calculator. If you are just interested in TI-Basic programming, please skip this page and move on to the [Variables](sk:variables.html) page.
...
Besides having the calculator files for the program, you should also read through the readme document that came with the .zip file (if there is one). Although most TI-Basic programs do not require any additional programs to run, some do require assembly libraries (such as [xLIB](xlib.html)). The majority of assembly programs require a [shell](asmshells.html), such as MirageOS or Ion. You should check to see what requirements the program has, and download the appropriate files.
...
|**[<< Computer Setup](sk:computer-setup.html)**|**[Table of Contents](starter-kit.html)**|**[Variables >>](sk:variables.html)**|
| --- | --- | --- |
