...
### Menu Location
This command is only found in the catalog menu. Press:<br># 2nd CATALOG to access the command catalog.<br># O to skip to commands starting with O.<br># ENTER to select OpenLib(.
# The OpenLib( Command
