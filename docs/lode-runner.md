# Lode Runner
![Lode Runner](lode-runner/lode_runner.gif style="width:200px; height:135px;" "Lode Runner")

|Program Summary|Program Size|Uses Libraries?|Calculator Compatibility|Author|Download|
| --- | --- | --- | --- | --- | --- |
|A quality version of the classic lode runner game.|3,000 bytes|No, it's pure TI-Basic|TI-83/84/+/SE|[SiCoDe](http://sicode.ticalc.org) (Brandon Green & Tim Parkin)|[loderunner.zip](http://tibasicdev.github.io/local--files/lode-runner/loderunner.zip)|
