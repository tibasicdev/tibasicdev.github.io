# Sudoku
![Sudoku](sudoku/sudoku.gif "Sudoku")

|Program Summary|Program Size|Uses Libraries?|Calculator Compatibility|Author|Download|
| --- | --- | --- | --- | --- | --- |
|A quality version of the classic sudoku game.|4,051 bytes|No, it's pure TI-Basic|TI-83/84/+/SE|[Harrierfalcon](http://www.ticalc.org/archives/files/authors/98/9849.html)|[sudoku.zip](http://tibasicdev.github.io/local--files/sudoku/sudoku.zip)|
