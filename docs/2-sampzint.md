...
### Menu Location
When editing a program, press:<br># STAT to access the statistics menu<br># LEFT to access the TESTS submenu<br># 9 to select 2-SampZInt(, or use arrows<br>(this key sequence will give you the 2-SampZInt... screen outside a program)
