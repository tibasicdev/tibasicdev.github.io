...
This code was made as an alternative to the previously existing [list-to-string](list-to-string.html) code.

## Related Routines

- [String to List](string-to-list.html)
- [List to String](list-to-string.html)
- [String to List Alternative](string-to-list2.html)
