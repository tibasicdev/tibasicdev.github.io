...
The absolute value of a complex or imaginary number can also be taken, but it is done a little differently.  If a complex number is written a+b*i*, then the absolute value of the number is √(a<sup>2</sup>+b<sup>2</sup>).
```
abs(5)
       5
abs(-5)
...
## Related Commands
- [`Negation`](68k:negative.html) ( <sup>-</sup> )
