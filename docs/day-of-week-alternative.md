...
[^1]: If you have a TI-84+/SE or a TI-8+ OS 1.15 (at least), replace `int(Ans/ᴇ2)` with `int(sub(Ans))`.
[^2]: Note: You can change the constant to 5 in the formula for returning Monday as 0, Tuesday as 1, etc.
