...
Now, I'm sure some of you are probably wondering what is so important about documentation and why it is necessary in the first place. You might even be asking, "If we design the program so it is [user-friendly](usability.html), isn't that good enough?" The answer to that question is a resounding NO! In reality, documentation is a crucial part of a program.
...
|**[<< Code Timings](timings.html)**|**[Overview](development.html)**|**[Marketing >>](marketing.html)**|
| --- | --- | --- |
