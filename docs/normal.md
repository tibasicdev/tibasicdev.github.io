...
The other possible settings are [Sci](sci.html) (which always uses scientific notation), or [Eng](eng.html) (which uses a specific form of scientific notation based on powers of 1000)
