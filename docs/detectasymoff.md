![The DetectAsymOff Command](detectasymoff/@ "The DetectAsymOff Command")
...
### Menu Location
Press:<br># 2nd FORMAT to access the graph format menu<br># Use arrows and ENTER to select "Off" under "Detect Asymptotes:"<br><br>It can also be found in the catalog.
