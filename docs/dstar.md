# DStar
![DStar](dstar/dstar.gif "DStar")

|Program Summary|Program Size|Uses Libraries?|Calculator Compatibility|Author|Download|
| --- | --- | --- | --- | --- | --- |
|A quality version of the classic dstar game.|4,800 bytes|No, it's pure TI-Basic|TI-83/84/+/SE|[Scott Davis](http://www.basiclimits.tk/)|[dstar.zip](http://tibasicdev.github.io/local--files/dstar/dstar.zip)|
