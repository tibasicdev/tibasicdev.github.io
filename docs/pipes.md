# Pipes
![Pipes](pipes/pipes.gif style="width:200px; height:135px;" "Pipes")

|Program Summary|Program Size|Uses Libraries?|Calculator Compatibility|Author|Download|
| --- | --- | --- | --- | --- | --- |
|A quality version of the classic pipes game.|5,276 bytes|No, it's pure TI-Basic|TI-83/84/+/SE|[Sean Sartell](http://www.ticalc.org/archives/files/authors/48/4833.html) (staind234)|[pipes.zip](http://tibasicdev.github.io/local--files/pipes/pipes.zip)|
