[A](#A) | [B](#B) | [C](#C) | [D](#D) | [E](#E) | [F](#F) | [G](#G) | [H](#H) | [I](#I) | [L](#L) | [M](#M) | [N](#N) | [O](#O) | [P](#P) | [Q](#Q) | [R](#R) | [S](#S) | [T](#T) | [U](#U) | [V](#V) | [W](#W) | [X](#X) | [Z](#Z) | [Miscellaneous](#Miscellaneous)


Some commands have a superscript next to them that indicates compatibility:
- <sup>83+</sup> indicates that the command requires a TI-83+, TI-83+SE, TI-84+, or TI-84+SE calculator.
- <sup>84+</sup> indicates that the command requires a TI-84+ or TI-84+SE calculator.
- <sup>84+2.30</sup> indicates that the command requires a TI-84+ or TI-84+SE calculator with OS 2.30 or higher.
...
° ([degree-symbol](degree-symbol.html))
<sup>r</sup> ([radian-symbol](radian-symbol.html))
<sup>T</sup> ([transpose](transpose.html))
×√ ([xroot](xroot.html))
³ ([cube](3.html))
³√( ([cube-root](cube-root.html))
= ([equal](equal.html))
≠ ([not equal](notequal.html))
< ([less than](lessthan.html))
> ([greater than](greaterthan.html))
≤ ([less than or equal to](lessthanequal.html))
≥ ([greater than or equal to](greaterthanequal.html))
□ ([plotsquare](plotsquare.html))
+ ([plotcross](plotcross.html))
∙ ([plotdot](plotdot.html))
<sup>-1</sup> ([inverse](inverse.html))
² ([square](2.html))
^ ([power](power.html))
...
, ([comma](characters.html))
' ([apostrophe](characters.html))
" ([quotation](characters.html))
: ([colon](characters.html))
π ([pi](pi.html))
