...
**This page lists all of the commands for the TI-83/84/SE/+ models. If you have a newer TI-84 Plus C Silver Edition or TI-84 Plus CE with a color display, please visit the [Color Command Index](command-index.html).**

To access more information about the command, click on the command to go to the dedicated page for that command. To view the commands divided into sections, go to the [Command Overview](commands.html). To view most of the commands as they would on the calculator itself through the menus, go to the [Command Menu Map](command-map-bw.html).
...
- [=](equal.html), [≠](notequal.html), [>](greaterthan.html), [≥](greaterthanequal.html), [<](lessthan.html), [≤](lessthanequal.html)
- [→](store.html), [!](factorial.html), [π](pi.html), [%](percent.html), <sup>[r](radian-symbol.html)</sup>, [°](degree-symbol.html)

## # {#Num}

- [ֿ¹](inverse.html), [²](2.html), [³](3.html)
- [√(](square-root.html), [³√(](cube-root.html)
...
- [ANOVA(](anova.html)
- [Ans](ans.html)
- [Archive](archive.html) <sup>83+</sup>
- [Asm(](asm-command.html) <sup>83+</sup>
- [AsmComp(](asmcomp.html) <sup>83+</sup>
- [AsmPrgm](asmprgm.html) <sup>83+</sup>
- [augment(](augment.html)
- [AUTO Answer](auto-answer.html)<sup>84+2.53MP</sup>
...
- [Boxplot](plotn.html#boxplot)

## C {#C}

- [checkTmr(](checktmr.html) <sup>84+</sup>
- [χ²cdf(](chisquarecdf.html)
- [χ²pdf(](chisquarepdf.html)
- [χ²-Test(](chisquare-test.html)
- [χ²GOF-Test(](chisquaregof-test.html) <sup>84+2.30</sup>
- [Circle(](circle.html)
- [CLASSIC](classic-mode.html)<sup>84+2.53MP</sup>
- [Clear Entries](clear-entries.html)
- [ClockOff](clockoff.html) <sup>84+</sup>
- [ClockOn](clockon.html) <sup>84+</sup>
- [ClrAllLists](clralllists.html)
- [ClrDraw](clrdraw.html)
- [ClrHome](clrhome.html)
- [ClrList](clrlist.html)
- [ClrTable](clrtable.html)
- [conj(](conj.html)
...
- [dayOfWk(](dayofwk.html) <sup>84+</sup>
- [dbd(](dbd.html)
- [DEC Answer](dec-answer.html)<sup>84+2.53MP</sup>
- [►Dec](-dec.html)
...
- [DiagnosticOn](diagnosticon.html)
- [dim(](dim.html)
- [Disp](disp.html)
...
- [ExecLib](execlib.html) <sup>84+</sup>
- [expr(](expr.html)
- [ExpReg](expreg.html)
...
- [Fcdf(](fcdf.html)
- [►F◄►D](-f-d.html)<sup>84+2.53MP</sup>
- [Fill(](fill.html)
- [Fix](fix.html)
- [Float](float.html)
- [fMax(](fmax.html)
...
- [fPart(](fpart.html)
- [Fpdf(](fpdf.html)
- [FRAC Answer](frac-answer.html)<sup>84+2.53MP</sup>
- [►Frac](-frac.html)
- [Full](full.html)
- [Func](func.html)
...
- [GarbageCollect](garbagecollect.html) <sup>83+</sup>
- [gcd(](gcd.html)
- [geometcdf(](geometcdf.html)
- [geometpdf(](geometpdf.html)
- [Get(](get.html)
- [GetCalc(](getcalc.html)
- [getDate](getdate.html) <sup>84+</sup>
- [getDtFmt](getdtfmt.html) <sup>84+</sup>
- [getDtStr(](getdtstr.html) <sup>84+</sup>
- [getKey](getkey.html)
- [getTime](gettime.html) <sup>84+</sup>
- [getTmFmt](gettmfmt.html) <sup>84+</sup>
- [getTmStr(](gettmstr.html) <sup>84+</sup>
- [Goto](goto.html)
...
- [Histogram](plotn.html#histogram)
- [Horiz](horiz.html)
...
- [invT(](invt.html) <sup>84+2.30</sup>
- [iPart(](ipart.html)
- [irr(](irr.html)
- [IS>(](is-.html)
- [IsClockOn](isclockon.html) <sup>84+</sup>
...
- [LnReg](lnreg.html)
- [log(](log.html)
- [logBASE(](logbase.html)<sup>84+2.53MP</sup>
- [Logistic](logistic.html)

## M {#M}

- [Manual-Fit](manual-fit.html) <sup>84+2.30</sup>
- [MATHPRINT](mathprint-mode.html)<sup>84+2.53MP</sup>
...
- [Menu(](menu.html)
- [min(](min.html)
- [ModBoxplot](plotn.html#modboxplot)

## N {#N}

- *[n](n.html)*
- [nCr](ncr.html)
- [n/d](n/d.html)<sup>84+2.53MP</sup>
- [nDeriv(](nderiv.html)
- [►n/d◄►Un/d](-n/d-un/d.html)<sup>84+2.53MP</sup>
- [►Nom(](-nom.html)
- [Normal](normal.html)
- [normalcdf(](normalcdf.html)
- [normalpdf(](normalpdf.html)
- [NormProbPlot](plotn.html#normprobplot)
- [not(](not.html)
- [nPr](npr.html)
- [npv(](npv.html)
...
- [OpenLib(](openlib.html) <sup>84+</sup>
- [or](or.html)
- [Output(](output.html)
...
- [randIntNoRep(](randintnorep.html)<sup>84+2.53MP</sup>
- [randM(](randm.html)
...
- [RectGC](rectgc.html)
- [ref(](ref.html)
- [remainder(](remainder.html)<sup>84+2.53MP</sup>
- [Repeat](repeat.html)
- [Return](return.html)
- [round(](round.html)
- [*row(](timesrow.html)
...
- [setDate(](setdate.html) <sup>84+</sup>
- [setDtFmt(](setdtfmt.html) <sup>84+</sup>
- [setTime(](settime.html) <sup>84+</sup>
- [setTmFmt(](settmfmt.html) <sup>84+</sup>
...
- [SortA(](sorta.html)
- [SortD(](sortd.html)
- [startTmr](starttmr.html) <sup>84+</sup>
- [statwizard-off](statwizard-off.html) <sup>84+2.55MP</sup>
- [statwizard-on](statwizard-on.html) <sup>84+2.55MP</sup>
- [stdDev(](stddev.html)
- [Stop](stop.html)
...
- [sub(](sub.html)
- [sum(](sum.html)
- [summation Σ(](summationsigma.html)<sup>84+2.53MP</sup>
...
- [Then](then.html)
- [Time](time.html)
- [timeCnv(](timecnv.html) <sup>84+</sup>
...
- [UnArchive](unarchive.html) <sup>83+</sup>
- [Un/d](un/d.html)<sup>84+2.53MP</sup>
- [uvAxes](uvaxes.html)
- [uwAxes](uwaxes.html)
...
- [xor](xor.html)
- [xyLine](plotn.html#xyline)

## Z {#Z}

- [ZBox](zbox.html)
- [ZDecimal](zdecimal.html)
- [ZFrac1/2](zfrac.html)<sup>84+2.53MP</sup>
- [ZFrac1/3](zfrac.html)<sup>84+2.53MP</sup>
- [ZFrac1/4](zfrac.html)<sup>84+2.53MP</sup>
- [ZFrac1/5](zfrac.html)<sup>84+2.53MP</sup>
- [ZFrac1/8](zfrac.html)<sup>84+2.53MP</sup>
- [ZFrac1/10](zfrac.html)<sup>84+2.53MP</sup>
...
- [ZQuadrant1](zquadrant1.html)<sup>84+2.53MP</sup>
