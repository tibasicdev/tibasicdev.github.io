...
### Menu Location
This command can only be found in the catalog. Press:<br># 2nd CATALOG to enter the command catalog<br># i to skip to commands starting with I<br># Scroll down to isClockOn and select it
