...
- [tpdf(](tpdf.html) (Student t distribution)
- [tcdf(](tcdf.html)
- [invT(](invt.html) — TI-84+/SE only
...
- [Fcdf(](fcdf.html)
- [ShadeF(](shadef.html)
- [binompdf(](binompdf.html) (binomial distribution)
- [binomcdf(](binomcdf.html)
- [poissonpdf(](poissonpdf.html) (Poisson distribution)
- [poissoncdf(](poissoncdf.html)
- [geometpdf(](geometpdf.html) (geometrical distribution)
