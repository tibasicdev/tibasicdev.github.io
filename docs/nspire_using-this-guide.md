...
- [Nspire:Subprograms](nspire:subprograms.html) — an idea you should be familiar with by now.
- [Saving Data](nspire:saving.html) — almost as easy as just storing to a variable.
- [Nspire:Assembly](nspire:assembly.html) — I'm not saying writing assembly is easy, but learning about it sure is.

#### Intermediate

- [Sprites](nspire:sprites.html) — a matter of learning several commands, and where to use them.
- [Animation](nspire:animation.html) — a natural second step from the above.
- [Dialogs](nspire:dialogs.html) — again, just learning a few commands.

#### Hard

- [Nspire:Compression](nspire:compression.html) — if you wanted, you could get into some heavy theory with this.
- [System Variables](nspire:system-variables.html) — almost more useful as a reference tool than anything else.
- [Tokenization](nspire:tokenization.html) — not much practical use, but it's useful to understand how things work.
- [Cross-Compatibility](nspire:cross-compatibility.html) — if only more people were aware of this...
