...
**[230 - Dimension](68k:errors.html#e230)** happens when taking sin() of a matrix that isn't square.
**[260 - Domain error](68k:errors.html#e260)** happens when taking sin() of a complex number in degree or gradian mode.
**[665 - Matrix not diagonalizable](68k:errors.html#e665)** happens when taking sin() of a matrix that isn't diagonalizable.
