...
**Answer**: ##e7e9dc|False. *i*<sup>2</sup> = -1##
...
**Answer**: ##e7e9dc|True. To get a different base, use the logBASE function or the formula: log(x)/log(b) = log<sub>b</sub>(x)##
...
|**[<< Chapter Summary](sk:summary-math.html)**|**[Table of Contents](starter-kit.html)**|**[Sample Program: Analog Clock >>](sk:math-sample.html)**|
| --- | --- | --- |
