...
1. We're interested in the probability that the event occurs a specific number of times in a given time.
...
1. We're interested in the probability that the event occurs 8 times in the time interval
