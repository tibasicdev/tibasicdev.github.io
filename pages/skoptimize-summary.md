...
- The [Output(](output.html) command can be used to display multiple lines of text by taking advantage of text wrapping.
- The [Text(](text.html) command can automatically concatenate multiple arguments into one output
