![The Pmt_End Command](pmt-end/PMT_END.GIF "The Pmt_End Command")
...
### Menu Location
On the TI-83, press:<br># 2nd FINANCE to access the finance menu.<br># ALPHA E to select Pmt_End, or use arrows and ENTER.<br><br>On the TI-83+ or higher, press:<br># APPS to access the applications menu.<br># ENTER to select Finance...<br># ALPHA E to select Pmt_End, or use arrows and ENTER.
# The Pmt_End Command
