...
### Menu Location
- Press [2nd] [MATH] to enter the [68k:math](68k:math.html) menu.<br>* Press 1 to open the Number submenu, or use arrows<br>* Press [ENTER] to past exact(<br><br>Alternativly, for ti-92/+/v200, type "exact(" using the keyboard.
# The exact() Command
