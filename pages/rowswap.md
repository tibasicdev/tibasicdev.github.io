...
### Menu Location
Press:<br># MATRX (on a TI-83) or 2nd MATRX (TI-83+ or higher) to access the matrix menu.<br># RIGHT to access the MATH submenu.<br># ALPHA C to select rowSwap(, or use arrows and ENTER.
# The rowSwap( Command
