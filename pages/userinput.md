...
![http://tibasicdev.github.io/local—files/userinput/SCREEN01.BMP](http://tibasicdev.github.io/local—files/userinput/SCREEN01.BMP "")
...
This method has no automatic command. This must be done manually and, as you can imagine, takes a lot of space. If you value speed over design, then don't bother. Otherwise, [this guide](custominput.html) will show you how to do it.
