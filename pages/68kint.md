![The int() Command](68k_int/int.png "The int() Command")
...
The command is an alias for [68k:floor()](68k:floor().html): they do the exact same thing. The calculator prefers using floor() (in fact, int() will be converted to floor() in symbolic expressions); int() is left over from earlier calculator models. Other rounding commands include:
