...
A program that takes the coefficients of a quadratic function and factors it using the [Factoring by Inspection](http://en.wikipedia.org/wiki/quadratic_equation#factoring_by_inspection) method, storing the new coefficients to L<sub>1</sub>.
