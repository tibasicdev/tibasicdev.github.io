...
Throughout code, in questionable parts, add [68k:Text](68k:text.html) commands that only display if 'debug' is true, and show the values of variables you're interested in:
```
If debug
...
|**[<< Commenting Code](68k:comments.html)**|**[Overview](68k:development-overview.html)**|**[Setup & Cleanup >>](68k:setup-and-cleanup.html)**|
| --- | --- | --- |
