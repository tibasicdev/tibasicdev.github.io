...
Although the correlation statistics are not displayed with `DiagnosticOff`, they are calculated in either case. This means that [`DiagnosticOn`](diagnosticon.html) and `DiagnosticOff` will not change how fast regressions are calculated. 
