...
You can also put common variables or expressions in a string variable and then use the [expr(](expr.html) command to reference them. This can be used in conjunction with other variable commands. This also gives you more variables to use.
...
|**[<< Displaying Text](sk:displaying-text.html)**|**[Table of Contents](starter-kit.html)**|**[Math Operations >>](sk:math-operations.html)**|
| --- | --- | --- |
