...
In addition to following the specifications, try to make the programs as optimized as possible, and use good design when structuring them (i.e., don't use [Goto](goto.html) when a [loop](while.html) is really what you should be using). If you can successfully make all of these programs, and have done a good job writing them, you can consider yourself a good programmer.

If you are having trouble making any of the programs, or you just want some input from other people, you can post in the [forum](forum:home.html). Before you do that, though, we encourage you to really try to create the programs and put some thought into them.
...
|**[<< What Next?](sk:what-next.html)**|**[Table of Contents](starter-kit.html)**|**[Command Cheat Sheet >>](sk:cheat-sheet.html)**|
| --- | --- | --- |
