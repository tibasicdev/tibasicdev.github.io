...
### Menu Location
Press:<br># [2nd] + [MATH] to access the [68k:math](68k:math.html) menu.<br># [RIGHT] to access the Number submenu.<br># 5 to select fPart(, or use arrows.<br>Alternativly, type "fPart(" with the keyboard
# The fPart() command
