# Using getKey
Once you have been writing programs for a while, you may realize that you can't accomplish everything by entering numbers and strings. In a program such as a game, you often need to accept arbitrary keypresses. That's where [getKey](getkey.html) comes in.
...
This will ignore all key presses until 105 (ENTER) is pressed. In this case, it is probably better to use [Pause](pause.html). But in general, getKey is a very useful tool for accepting a wide range of user input.

<center>

|**[<< More on the Home Screen](sk:homescreen.html)**|**[Table of Contents](starter-kit.html)**|**[Movement >>](sk:movement.html)**|
| --- | --- | --- |
